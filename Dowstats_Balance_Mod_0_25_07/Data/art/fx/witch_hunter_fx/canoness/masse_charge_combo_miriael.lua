fxtypes =  
{
	...
	{
		effect = "root>masse_charge_ring_01",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "WITCH_HUNTER_FX/CANONESS/EYE_GLOW.JPG",
				},
				property_21 =  
				{
					name = "Mesh",
	...
	{
		effect = "root>masse_eclairs>unit_thunder_hammer_beam",
		fx =  
		{
			properties =  
			{
